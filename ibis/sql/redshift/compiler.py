...
class RedshiftExprTranslator(alch.AlchemyExprTranslator):
...
rewrites = RedshiftExprTranslator.rewrites
compiles = RedshiftExprTranslator.compiles


class RedshiftDialect(alch.AlchemyDialect):
